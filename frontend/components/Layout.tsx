      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: 9, color: "#4B5563", marginTop: 1, letterSpacing: "0.05em", fontWeight: 600 }}>DOMAIN ENGINE</div>
          </div>
        </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" }}>
        ...
        <header style={{
          ...
          <div style={{ fontSize: 10, color: "#4B5563", fontFamily: "'Space Mono', monospace", fontWeight: 500, letterSpacing: "0.02em" }}>
            [ SYSTEM::READY ] SECURE_CHANNEL_ENCRYPTED
          </div>
          <RoleSwitcher />
        </header>

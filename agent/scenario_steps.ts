...
export function getRtoSteps(caseId: string): StepDef[] {
  return [
    ...
    },
    {
      ...
      observation_text: "CRITICAL: AWB DHL909876 status is RTO (Return to Origin). Customer refused delivery on 2026-03-13. No POD. Recommending acceptance review rather than contest.",
      status: "warning",
    },
    {
      action_type: "tool_call",
    ...
    },
    {
      ...
      output_json: { dispute_policy: "Recommend acceptance for RTO disputes after approver confirmation. Initiate refund per RTO SLA.", rto_sla_days: 7 },
      observation_text: "Merchant policy: RTO disputes can move toward acceptance after approver confirmation. Refund per 7-day RTO SLA.",
      status: "success",
    },
    {
      action_type: "observe",
      tool_name: null,
      input_json: {},
      output_json: { recommended_action: "Accept", confidence_band: "High", logistics_status: "RTO", approval_required: true },
      observation_text: "Policy engine returned: ACCEPT (High confidence). Logistics status is RTO and non-delivery is confirmed by the carrier. Acceptance remains irreversible, so approver confirmation is required before finalizing.",
      status: "success",
    },
  ];
}

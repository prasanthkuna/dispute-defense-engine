...
```bash
git remote add encore encore://dispute-defense-engine-5ayi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/dispute-defense-engine-5ayi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/dispute-defense-engine-5ayi/settings/integrations/github)

  ...
  return [
    {
      ...
      summary_text: "UPI payment of ₹2,499 captured on 2026-03-25. VPA: priya.sharma@okicici.",
      raw_content_json: { payment_id: "pay_abc123", amount: 2499, status: "captured", method: "upi" },
      preview_text: "pay_abc123 | ₹2,499 | captured | UPI",
      status: "found",
      confidence: 1.0,
    },
    {
    ...
    },
    {
      ...
      summary_text: "GST-compliant tax invoice INV-4521 for ₹2,499. HSN 61091000. GSTIN: 06AABCU9603R1ZP.",
      raw_content_json: { invoice_id: "INV-4521", amount: 2499, gst: 380.36 },
      preview_text: "INV-4521 | ₹2,499 | GST: ₹380.36",
      status: "found",
      confidence: 1.0,
    },
    {
  ...
  return [
    {
      ...
      summary_text: "NetBanking payment of ₹5,899 captured on 2026-03-20. Bank: HDFC.",
      raw_content_json: { payment_id: "pay_def456", amount: 5899, status: "captured", method: "netbanking" },
      preview_text: "pay_def456 | ₹5,899 | captured | NetBanking",
      status: "found",
      confidence: 1.0,
    },
    {
  ...
  return [
    {
      ...
      summary_text: "Visa card payment of ₹14,999 captured on 2026-03-10.",
      raw_content_json: { payment_id: "pay_ghi789", amount: 14999, status: "captured", method: "card" },
      preview_text: "pay_ghi789 | ₹14,999 | captured | Visa",
      status: "found",
      confidence: 1.0,
    },
    {
    ...
    },
    {
      ...
      summary_text: "Invoice INV-2291 for ₹14,999.",
      raw_content_json: { invoice_id: "INV-2291", amount: 14999 },
      preview_text: "INV-2291 | ₹14,999",
      status: "found",
      confidence: 1.0,
    },
    {
  ...
  return [
    {
      ...
      summary_text: "UPI payment of ₹899 captured on 2026-03-18.",
      raw_content_json: { payment_id: "pay_jkl012", amount: 899, status: "captured", method: "upi" },
      preview_text: "pay_jkl012 | ₹899 | captured | UPI",
      status: "found",
      confidence: 1.0,
    },
    {
